...
copyMarkdownFiles("research commands", join(sourceRoot, "commands"), join(targetRoot, ".claude", "commands"));
copyMarkdownFiles("research agents", join(sourceRoot, "agents"), join(targetRoot, ".claude", "agents"));
removeLocalLockEntry(targetRoot, "research");

console.log(`Research slash command installed in ${targetRoot}`);
